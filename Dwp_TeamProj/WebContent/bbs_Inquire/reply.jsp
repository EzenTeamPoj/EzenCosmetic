...
MemberBean objMB = mMgr.modifyMember(uId);
String aId = (String)session.getAttribute("aId_Session");
String replyId ="";
String replyName = "";
if(uId != null) {
	replyId = uId;
	replyName = objMB.getuName();
} else if (aId != null ) {
	replyId = aId;
	replyName = "관리자";
}
...
String qnaType=bean.getQnaType();
%>    
    	...
    	<main id="main" class="dFlex">
    		...
    		<div id="contents" class="reply">
				...
				<form name="replyFrm" action="replyProc.jsp"
						...
						<tfoot>	
							...
							<tr>
								<td colspan="2" id="btnAreaTd" class="reply">
									<button type="button" id="inqReplyBtn">답변등록</button>
					...
					<input type="hidden" name="uId" value="<%=replyId%>">	
					...
					<input type="hidden" name="bbsPw" value="<%=bbsPw%>">
