  ...
  <body>
	...
	<form action="/Member/Join_Proc.jsp" id="joinFrm">
	 ...
	 <!-- dpChk: duplicateChek -->
	     ...
	     <td>
	     <input type="password" id="uPwdpChk" class="reqs">
	     <span id="pwChk"></span>
	     </td>
	     </tr>
	     <tr>
	     ...
	     name="uName" id="uName" class="reqs"></td>
	     </tr>
	     <tr>
	     <th class="req">이메일</th>
	     <td>
	     <input type="text" id="uEmail1" maxlength="10" class="reqs">
	     <span>@</span>
	     <input type="text" id="uEmail2" maxlength="15" class="reqs">
 	     <select id="valSel">
	     ...
	     <td>
	     <input type="text" id="postcode" placeholder="우편번호" class="reqs">
	     ...
	     <th class="req">주소</th>
	     <td>
         <input type="text" id="address" placeholder="주소" class="reqs refList"><br>
         </td>
         </tr>
         <tr>
         <td colspan="2">
        ...
        <td>
        <input type="text" id="Year" class="birth" maxlength="4">
        <input type="text" id="Month" class="birth" maxlength="2">
        <input type="text" id="Day" class="birth" maxlength="2">
	    ...
	    <th>추천인 아이디</th>
	     <td>
	     <label>
	     <input type="text" name="recoPerson" class="reqs">
	     </label>
	     </td>
	     </tr>
	     <tr>
