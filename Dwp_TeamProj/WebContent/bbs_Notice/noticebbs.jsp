								...
								<form name="searchFrm" id="searchFrm" class="dFlex">
									...
									<select name="keyField" id="keyField">
										<option value="asubject" 
												<% if(keyField.equals("asubject")) out.print("selected"); %>>제  목</option>
										<option value="aName" 
												<% if(keyField.equals("aName")) out.print("selected"); %>>이  름</option>
										<option value="acontent" 
												<% if(keyField.equals("acontent")) out.print("selected"); %>>내  용</option>
									</select>
									</div>
									<div>
