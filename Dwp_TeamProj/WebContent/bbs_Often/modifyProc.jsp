...
<jsp:useBean id="bean" class="pack_Often.BoardBean" scope="session" />
<!-- Read.jsp에서 DB 에서 자료를 반환하여 session을 만들 때 세션이름을 "bean"으로,
       세션에 저장되는 값을 DB에서 반환된 자료를 setter로 저장한 BoardBean 객체를
       생성했었음 -->         
       
<jsp:useBean id="upBean" class="pack_Often.BoardBean" scope="page" />
...
if (exeCnt > 0) {
	String url = "/bbs_Often/read.jsp?nowPage="+nowPage;
