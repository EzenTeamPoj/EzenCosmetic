...
<jsp:useBean id="upBean" class="pack_ReviewBoard.ReviewBoardBean" scope="page" />
...
<jsp:useBean id="objMgr" class="pack_ReviewBoard.ReviewBoardMgr" scope="page" />
<!-- id="bMgr" 유즈빈은 bMgr.updateBoard(upBean) 실행용도
       => 실제 게시글이 DB와 연동하여 수정됨 -->
<%    
int exeCnt = objMgr.updateBoard(upBean);
